...
import { TrackNumber, ItemData } from '../../../common/components/track-number';
import { Screen } from '@dev-dep/ui-nucleons/screen';

const cx = classNames.bind(classes);

export interface TrackingInfoScreenProps {
  trackNumbers?: ItemData[]
  deliverySite?: string
  onCopy?: (item: ItemData) => void
  onClose?: () => void
}
 ...
 * @param props.onClose Обработчик клика по кнопке "Закрыть".
    ...
    >
      <div className={cx('wrap')}>
        ...
        <div className={cx('text')}>
          Чтобы узнать, где находится ваша посылка, введите на сайте
          {' '}
          {deliverySite}
          {' '}
