...
describe('<ModifierButton />', () => {
  it('should render without props', () => {
    const wrapper = mount(<ModifierButton />);

    expect(wrapper).toMatchSnapshot();
  });

  it('should render count', () => {
    const wrapper = mount(<ModifierButton count={12} />);
  ...
  it('should render markdown and count', () => {
    const wrapper = mount(<ModifierButton count={666} isMarkdown />);
  ...
  it('should handle "selected" properly', () => {
    const wrapper = mount(<ModifierButton selected />);
  ...
  it('should handle "color" properly', () => {
    const wrapper = mount(<ModifierButton color='#bada55' />);
    expect(wrapper).toMatchSnapshot();
  ...
  it('should handle "type" and "content" properly', () => {
    const wrapper = mount(<ModifierButton type='text' content='Test content' />);
  ...
  it('should handle "className" properly', () => {
    const wrapper = mount(<ModifierButton className='test-class' />);

    expect(wrapper).toMatchSnapshot();
  });

  it('should not show title when type is color', () => {
    const wrapper = mount(<ModifierButton type='color' content='content' />);
  ...
  it('should handle "onClick" prop', () => {
    ...
    const wrapper = shallow(
      <ModifierButton className='test-class' content='Test content' type='text' onClick={spy} />,
    );
